...
@section('content')
    ...
    <div ng-controller="teaAddExamCtrl" style="display: none" id="add_exam_div">
                ...
                <div class="panel-body">
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <button type="button" class="btn btn-outline-success btn-block" ng-click="addExam()" style="margin-top: 7px">เพิ่มข้อสอบ</button>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#add_exam_div').css('display', 'block');
