...
@section('content')
    ...
    <div ng-controller="teaCopyExamCtrl" style="display: none" id="copy_exam_div">
        <div class="col-md-12 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{ url('/home')}}">หน้าหลัก</a></li>
                <li>คลังข้อสอบ</li>
                <li><a href="{{ url('/teacher-exam-share')}}">ข้อสอบที่แบ่งปันกับฉัน</a></li>
        ...
        <div class="col-md-12 col-xs-12">
            <div class="panel panel-default" id="copy_exam_part">
                <div class="panel-heading">
                    <b style="color: #555">คัดลอกข้อสอบ</b>
                </div>
                <div class="panel-body">
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <button type="button" class="btn btn-outline-success btn-block" ng-click="copyExam()" style="margin-top: 7px">บันทึกข้อสอบ</button>
                            </div>
                            <div class="col-md-3">
