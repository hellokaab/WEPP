...
@section('content')
    ...
    <div ng-controller="teaAddExamingCtrl" style="display: none" id="add_examing_div">
        ...
        <div class="col-md-12 col-xs-12">
            <div class="panel panel-default" id="add_examing_part">
                ...
                <div class="panel-body">
                    <div class="form-horizontal" role="form">
                        ...
                        <div class = "form-group">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-outline-success btn-block" value="เปิดสอบ" ng-click="openExam()" style="margin-top: 7px">เปิดสอบ</button>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#side_open_examing').attr('class', 'active');
