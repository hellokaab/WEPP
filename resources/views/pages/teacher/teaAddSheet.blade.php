...
@section('content')
    ...
    <div ng-controller="teaAddSheetCtrl" style="display: none" id="add_sheet_div">
                ...
                <div class="panel-body">
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="button" class="btn btn-outline-success btn-block" style="margin-top: 7px" ng-click="addSheet()"
                                       value="เพิ่มใบงาน"/>
                            </div>
                            <div class="col-md-3">
