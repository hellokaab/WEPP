...
@section('page-title','แก้ไขใบงาน')
@section('content')
    <script src="js/Components/teacher/teaEditSheetCtrl.js"></script>
    <script>
        var sheetID = {{$sheetID}};
    </script>
    <style>
    ...
    <div ng-controller="teaEditSheetCtrl" style="display: none" id="edit_sheet_div">
        <div class="col-md-12 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{ url('/home')}}">หน้าหลัก</a></li>
                <li>คลังใบงาน</li>
                <li><a href="{{ url('/teacher-sheet-my')}}">ใบงานของฉัน</a></li>
            ...
            <div class="panel panel-default" id="edit_sheet_part">
                ...
                <div class="panel-body">
                    <div class="form-horizontal" role="form">
                        ...
                        <form id="outputFileForm" onsubmit="return submitOutputForm()" method="post" enctype = "multipart/form-data"> {{--action="javascript:submitOutputForm();"--}}
                                ...
                                <div class="form-group has-feedback" ng-repeat="q in quizzes" style="padding-left: 15px;padding-right: 15px">
                                    <div id="oldQuiz_part_<%q.id%>" style="padding-left: 15px;padding-right: 15px">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1 hidden-xs hidden-sm" style="padding-left: 0px">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-outline-success btn-block" style="margin-top: 7px" ng-click="editSheet()">บันทึกใบงาน</button>
                            </div>
                            <div class="col-md-3">
                                <button class="btn btn-outline-danger btn-block" style="margin-top: 7px" ng-click="goBack()">ยกเลิก</button>
                            </div>
                        </div>
                    </div>
                </div>
