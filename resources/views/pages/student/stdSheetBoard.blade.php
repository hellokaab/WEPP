...
@section('content')
    ...
    <div ng-controller="stdSheetBoardCtrl" style="display: none" id="sheet_board_div">
        <div class="col-md-12 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li ng-if="user.user_type ==='s' || user.user_type ==='o'"><a href="{{ url('/student-group-in-<%sheeting.group_id%>')}}"><%group.group_name%> (<%group.creater%>)</a></li>
                <li ng-if="user.user_type ==='t'"><a href="{{ url('/teacher-group-other-in-<%sheeting.group_id%>')}}"><%group.group_name%> (<%group.creater%>)</a></li>
